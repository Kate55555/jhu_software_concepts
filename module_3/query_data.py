...
def problem_3(connection):
    ...
    WHERE
        ...
        AND gre_aw <= 6
    ;"""
    averages = execute_read_query(connection, select_averages)
    return averages


def problem_4(connection):
    ...
    ;"""
    average_gpa = execute_read_query(connection, select_average)
...
def problem_5(connection):
    ...
    WHERE
        term = 'Spring 2025'
    ;"""
    accepted = execute_read_query(connection, select_accepted)
    # Compute percentage
...
def problem_7(connection):
    ...
    ;"""
    jhu_masters_cs = execute_read_query(connection, select_JHU)
...
if __name__ == "__main__":
    ...
    # Problem 2
    print(f"2. Entries from international students: ")
