...
src\order.py - The order class with methods to initialize, add pizzas to an order, mark as paid, and stringify.

src\pizza.py - The pizza class with methods to initialize, stringify an object, and get a pizza cost.
